...
public class NRProjectConfigEditor : UnityEditor.Editor
{
    ...
    public static void DrawUniqueProjectConfig(NRProjectConfig projectConfig)
    {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.Space();
        EditorGUILayout.LabelField("NativeSessionManager", EditorStyles.boldLabel);
        EditorGUILayout.BeginVertical(EditorStyles.helpBox);
        NREditorUtility.BoolField(projectConfig, "enable", ref projectConfig.enableNativeSessionManager, ref modify);
        EditorGUILayout.EndVertical();
